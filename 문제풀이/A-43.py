...
정부에서는 일부 가로등을 비활성화하되, 
마을에 있는 임의의 두 집에 대하여 가로등이 켜진 도로만을 절약하고자 합니다.
...
출력 조건
첫째 줄에 일부 가로등을 비활성화하여 "절약할 수 있는 최대 금액"을 출력합니다.
...
[내 풀이]
 : 전형적인 크루스칼 알고리즘(최소 신장트리), 
    문제에서 묻는 것 : 절약할 수 있는 비용
 
[답지]
 : "임의의 두 집에 대하여 가로등이 켜진 도로만으로도 오갈 수 있도록"
    같은 문장이 있으면 최소신장트리를 의심하여라.
"""
import sys
